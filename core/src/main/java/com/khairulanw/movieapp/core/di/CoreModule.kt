package com.khairulanw.movieapp.core.di

import androidx.room.Room
import com.khairulanw.movieapp.core.data.MovieRepository
import com.khairulanw.movieapp.core.data.source.local.LocalDataSource
import com.khairulanw.movieapp.core.data.source.local.room.MovieDatabase
...
import java.util.concurrent.TimeUnit
    ...
    val databaseModule = module {
        ...
        single {
            val passphrase: ByteArray = SQLiteDatabase.getBytes("khairulanw".toCharArray())
